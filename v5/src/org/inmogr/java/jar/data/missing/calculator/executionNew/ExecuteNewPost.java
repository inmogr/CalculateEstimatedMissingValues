...
public class ExecuteNewPost extends ExecuteNew {
	...
	public ExecuteNewPost(String pathOriginal, String pathWithMissing, String pathRowsReference, double marginOfError) {
		super(pathOriginal, pathWithMissing, pathRowsReference);
